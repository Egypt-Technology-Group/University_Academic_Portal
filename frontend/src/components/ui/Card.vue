<template>
  ...
  >
    <div v-if="$slots.header" class="border-b border-slate-100 pb-4 mb-4">
    ...
    <div v-if="$slots.footer" class="border-t border-slate-100 pt-4 mt-4">
...
defineProps({
  ...
  padding: {
    type: String,
    default: 'md',
    validator: (p) => ['none', 'sm', 'md', 'lg', 'xl'].includes(p),
  },
  customClass: {
    type: String,
    default: '',
