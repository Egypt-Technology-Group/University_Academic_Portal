<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-8 py-10 space-y-10">
    ...
    <div v-else-if="filteredDocs.length === 0" class="text-center py-16 bg-white rounded-2xl border border-slate-200 space-y-3">
      ...
      <p class="text-slate-600 font-semibold">{{ $t('documents.noDocs') }}</p>
    </div>
