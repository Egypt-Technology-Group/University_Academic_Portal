...
{
    /**
     * Run the database seeds for default dynamic site settings.
     */
    public function run(): void
    {
        $settings = [
            ...
            // 2. Theme & Colors (Non-technical palette customization)
            [
                'key' => 'theme_colors',
                'group' => 'theme',
                'is_public' => true,
                'value' => [
                    ...
                    'header_style' => 'classic', // classic, minimal, modern_glass
                ],
            ],

            // 3. University President & Leadership Message
            [
            ...
            // 9. Site Statistics & Numerical Counters (Dynamic Public Facts & Metrics)
            [
                'key' => 'site_statistics',
                'group' => 'statistics',
                'is_public' => true,
